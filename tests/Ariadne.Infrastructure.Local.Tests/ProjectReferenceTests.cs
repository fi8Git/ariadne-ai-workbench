...
namespace Ariadne.Infrastructure.Local.Tests;

public class ProjectReferenceTests
{
    [Fact]
    public void InfrastructureLocalProjectDependsOnAllowedProjects()
    {
        string projectPath = FindRepositoryFile("src", "Ariadne.Infrastructure.Local", "Ariadne.Infrastructure.Local.csproj");

        Assert.Equal(
            [
                "..\\Ariadne.Analytics\\Ariadne.Analytics.csproj",
                "..\\Ariadne.Application\\Ariadne.Application.csproj",
